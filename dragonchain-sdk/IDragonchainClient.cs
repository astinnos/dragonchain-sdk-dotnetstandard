...
namespace dragonchain_sdk
{
    public interface IDragonchainClient
    {
        ...
        Task<ApiResponse<DragonchainContractCreateUpdateResponse>> CreateContract(ContractCreationSchema body);
        ...
        Task<ApiResponse<SmartContractAtRest>> DeleteSmartContract(string contractId);
        ...
        Task<ApiResponse<string>> GetSmartContractHeap(string key, string scName);
        ...
        Task<ApiResponse<DragonchainContractCreateUpdateResponse>> UpdateSmartContract(string contractId, string image = null, string cmd = null, SmartContractExecutionOrder? executionOrder = null, SmartContractDesiredState? desiredState = null, string[] args = null, object env = null, object secrets = null, int? seconds = null, string cron = null, string auth = null);
